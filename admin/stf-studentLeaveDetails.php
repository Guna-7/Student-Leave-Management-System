...
?>
                                ...
                                <tr>
    <td style="font-size:16px;"><b>OD Category :</b></td>
    <td><?php echo htmlentities($result->od_category); ?></td>
    <td colspan="4"></td> <!-- Colspan to adjust for the merged cells in the table -->
</tr>
                                <tr>
                                    <td style="font-size:16px;"><b>Number of Days:</b></td>
                                    <td><?php echo htmlentities($result->num_of_days);?></td>
                                    <td colspan="4"></td> <!-- Colspan to adjust for the merged cells in the table -->
                                </tr>
                                <tr>
                                ...
                                <?php if ($stats == 0 && $result->num_of_days > 2): ?>
<tr>
    <td colspan="6">
        <form name="staffaction" method="post">
            <select class="browser-default" name="status" required="">
                <option value="">Choose your option</option>
                <option value="2">Not Approved</option>
                <option value="3">Forwarded</option> <!-- New option for "forward" -->
            </select>
