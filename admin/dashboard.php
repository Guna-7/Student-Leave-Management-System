                    ...
                    <div class="col s12 m12 col-md-4 l4">
                        <div class="card stats-card border-0 shadow bg-dark ">
                            <div class="card-content">
                                ...
                                <span class="card-title text-white">Total Regd Students</span>
...
?>
                        ...
                        <div class="card stats-card border-0 shadow bg-dark">
                            <div class="card-content">
                                ...
                                <span class="card-title text-white">Total Class </span>
    <?php
...
?>                            
                    ...
                    <div class="col s12 m12 col-md-4 l4">
                        <div class="card stats-card border-0 shadow bg-dark">
                            <div class="card-content">
                                <span class="card-title text-white">Total Staff</span>
                                    <?php
$sql = "SELECT staff_id from  tblstaff";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
                             ...
                             <table id="example" class="display responsive-table bg-transparent">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200" class="text-danger">Student Name</th>
