...
.succWrap{
  ...
  <?php include('dh/header.php');?>
   ...
   <main class="mn-inner" id="one">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: green;">Update Student details</div>
                    </div>
...
<label for="empcode">Student Reg no</label>
...
<div class="input-field col m6 s12">
                                                        <select name="class" autocomplete="off">
                                                            ...
                                                            if($query->rowCount() > 0) {
                                                                foreach($results as $result) { ?>                                            
                                                                    <option value="<?php echo htmlentities($result->class_name); ?>"><?php echo htmlentities($result->class_name); ?></option>
                                                                <?php } 
                                                            }?>
                                                        </select>
                                                    </div>
