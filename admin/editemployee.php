...
$sql="UPDATE tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,class_id=:class,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where id=:eid";
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <h4 style="color: green;">Update Student Details</h4>
...
<div class="input-field col m6 s12">
                                                                <select name="class" autocomplete="off">
                                                                    ...
                                                                    if($query->rowCount() > 0) {
                                                                        foreach($results as $result) { ?>                                            
                                                                            <option value="<?php echo htmlentities($result->class_id); ?>"><?php echo htmlentities($result->class_id); ?></option>
                                                                        <?php } 
                                                                    }?>
                                                                </select>
                                                            </div>
