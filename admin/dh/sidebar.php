...
{               ?>  
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons"></i>Change Password</a></li>
                    <li class="no-padding">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="apply-od.php">Apply OD</a></li>
                                <li><a href="leavehistory.php">Leave History</a></li>
                                <li><a href="uploads.php">Upload File</a></li>
                            </ul>
                        </div>
                    </li>
                  ...
                  <li class="no-padding">
                                ...
                                <a class="waves-effect waves-grey" href="logout.php"><i class="material-icons"></i>Logout</a>
                            </li>  
                 
                   
                </ul>
                <div class="footer">
                    <p class="copyright"><a href="http://adhiyamaan.ac.in/ace/"> ACE </a>©</p>
