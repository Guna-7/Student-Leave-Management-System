                    ...
                    <div class="card-content">
                        ...
                        <table id="example" class="display responsive-table ">
                            <tbody>
                               ...
                               $sql = "SELECT tblleaves.id as lid, tblemployees.FirstName, tblemployees.LastName, tblemployees.EmpId, tblemployees.id, tblemployees.Gender, tblemployees.Phonenumber, tblemployees.EmailId, tblemployees.class_name, tblleaves.LeaveType, tblleaves.ToDate, tblleaves.FromDate, tblleaves.Description, tblleaves.PostingDate, tblleaves.Status, tblleaves.AdminRemark, tblleaves.AdminRemarkDate, s.StaffName as ForwardedStaffName
                                       FROM tblleaves
                                       JOIN tblemployees ON tblleaves.empid = tblemployees.id
                                       LEFT JOIN (SELECT s.StaffName, c.class_name
                                                   FROM tblstaff s
                                                   INNER JOIN staff_assignments sa ON s.ID = sa.staff_id
                                                   INNER JOIN classes c ON sa.class_id = c.class_id) s ON tblemployees.class_name = s.class_name
                           ...
                           ?>
                                <tr>
                                    ...
                                    <td style="font-size:16px;"><b>Std Id :</b></td>
                                    <td><?php echo htmlentities($result->EmpId);?></td>
                                    <td style="font-size:16px;"><b>Gender :</b></td>
                                    <td><?php echo htmlentities($result->Gender);?></td>
                                </tr>
                                <tr>
                                    <td style="font-size:16px;"><b>Std Email id :</b></td>
                                    <td><?php echo htmlentities($result->EmailId);?></td>
                                    <td style="font-size:16px;"><b>Std Contact No. :</b></td>
                                ...
                                <tr>
                                    <td style="font-size:16px;"><b>Student Leave Description : </b></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"><?php 
                                        ...
                                        if ($stats == 1) {
                                            ...
                                            echo "<span style='color: orange'>Forwarded</span>";
                                        }
                                    ?></td>
                                </tr>
                                <tr>
                                    <td style="font-size:16px;"><b>Class Name:</b></td>
                                    <td colspan="5"><?php echo htmlentities($result->class_name);?></td>
                                </tr>
                                <tr>
                                    <td style="font-size:16px;"><b>Staff  </b></td>
                                    <td colspan="5"><?php echo htmlentities($result->ForwardedStaffName);?></td>
                                </tr>
