...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>ACE | Password Recovery</title>
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
          ...
          <!--   <a class="nav-item text-white font-weight-bold nav-link active ml-3" href="#">Home <span class="sr-only">(current)</span></a> -->
            ...
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="index.php">Student Login</a>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <h4 class="font-weight-bold text-center text-danger">ACE LMS</h4>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">

                                  <div class="card-content ">
                                      <span class="card-title text-danger" style="font-size:20px;">Student details</span>
                                           ...
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="input-field col s12">
                                                ...
                                                <div class="input-field col s12">
                                                   ...
                                                   <label for="email">Enter Registered Student Id</label>
                                               </div>
