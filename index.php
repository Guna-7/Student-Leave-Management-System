...
<html lang="en">
    ...
    <body style="background:url('./login.jpg')">
        ...
        <h4 class="font-weight-bold text-center text-danger">ACE </h4>
                          ...
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title text-danger" style="font-size:20px;">Student Login</span>
                                       ...
                                       <div class="row">
                                           <form class="col col-md-12 " name="signin" method="post">
                                               ...
                                               <div class="col col-md-12 center m-t-sm">
                                                  ...
                                                  <a class="waves-effect waves-grey" href="forgot-password.php" style="margin-bottom: 10px; margin-left: 10px;">Student Password Recovery?</a>
                                               </div>
                                           </form>
                                      </div>
                                  </div>
